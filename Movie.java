...
public class Movie {
    ...
    /*public Movie(String movieTitle, Date movieDate, double rating, double runtime, String[] theaters, Double[] availableTimes) {
    ...
    public void setAvailableTimes(Double[] availableTimes) {
        this.availableTimes = availableTimes;
    }
